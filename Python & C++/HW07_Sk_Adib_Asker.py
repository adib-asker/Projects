...
We can notice that in Bells the ratio of a/an is higher then Canto's meaning that the uses
differ one to another.

On the other hand, we can observe that the same thing happended with the/then ratio
